...
function Button({ children, disabled, to, type, onClick }) {
  const base =
    "inline-block text-sm text-stone-800 bg-yellow-400" +
  ...
  const styles = {
    ...
    secondary:
      "inline-block text-sm text-stone-400 border-2 border-stone-300" +
      " font-semibold uppercase tracking-wide rounded-full" +
      " hover:bg-stone-300 hover:text-stone-800" +
      " transition-colors duration-300" +
      " focus:outline-none focus:ring focus:ring-stone-200 focus:ring-offset-2 focus:text-stone-800" +
